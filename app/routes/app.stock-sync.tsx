...
const ONLINE_LOCATION_NAMES = ["Main Warehouse", "Online Warehouse"];
const STORE_LOCATION_NAMES = ["Cape Town Store", "Canal Walk", "Bellville"];
...
export default function StockSyncPage() {
  ...
  return (
    <div style={{ padding: 20 }}>
      ...
      <p><strong>Online locations:</strong> {data.onlineLocations.join(", ")}</p>
      <p><strong>Store locations:</strong> {data.storeLocations.join(", ")}</p>
